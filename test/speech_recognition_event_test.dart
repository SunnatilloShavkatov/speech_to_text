...
void main() {
  group("properties", () {
    test("status listening matches", () {
      final SpeechRecognitionEvent event = SpeechRecognitionEvent(
    ...
    test("error matches", () {
      final SpeechRecognitionEvent event = SpeechRecognitionEvent(SpeechRecognitionEventType.errorEvent,
